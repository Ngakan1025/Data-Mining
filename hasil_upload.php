...
include_once 'lib/IDNstemmer.php';
include('lib/Enhanced_CS.php');
...
$st = new IDNstemmer();
$konek = mysqli_connect("localhost","root","","datamining");

$no=1;
echo "<p>Data yang telah dimasukan.</p>
</div>
    </div>
<div class='row mt'>  
...
<div class="container" style="margin-top:200px;">
   <div class="well text-center">
     ...
     if (move_uploaded_file($lokasi_file,"$folder")){
       echo "<h3>Nama File : <b>$nama_file</b> sukses di upload</h3><hr>";
